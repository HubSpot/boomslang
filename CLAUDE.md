...
Execute Python 3.14 from Java via WebAssembly (Chicory). Full docs: `docs/` (mdBook, published at https://github.hubspot.com/boomslang/). The build docs at `docs/src/contributing/building.md` are the source of truth; this file is the short version.
