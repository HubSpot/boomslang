...
```text
core/src/main/resources/python-overlay/usr/local/lib/python3.15/boomslang_host/asyncio.py
→ <stdlibPath>/usr/local/lib/python3.15/boomslang_host/asyncio.py
```
