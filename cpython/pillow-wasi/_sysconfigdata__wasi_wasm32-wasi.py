...
build_time_vars = {
    ...
    'CONFIG_ARGS': "'-C' '--host=wasm32-wasip1' '--build=x86_64-pc-linux-gnux32' '--with-build-python=python3' 'build_alias=x86_64-pc-linux-gnux32' 'host_alias=wasm32-wasip1' 'PKG_CONFIG_PATH=' 'PKG_CONFIG_LIBDIR=/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi/pkgconfig' 'CC=/wasi-sdk/bin/clang' 'CFLAGS=-O0 -Wno-int-conversion  ' 'LDFLAGS= '",
    'CONFINCLUDEDIR': '/usr/local/include',
    'CONFINCLUDEPY': '/usr/local/include/python3.14',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/wlr/build-staging/python/v3.14.5/checkout/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/wlr/build-staging/python/v3.14.5/checkout/lcov-report',
    ...
    'HAVE__GETPTY': 0,
    'HAVE___UINT128_T': 1,
    'HOSTRUNNER': 'wasmtime run --wasm max-wasm-stack=16777216 --wasi preview2=n --env PYTHONPATH=/$(shell realpath --relative-to /wlr/build-staging/python/v3.14.5/checkout /wlr/build-staging/python/v3.14.5/checkout)/$(shell cat pybuilddir.txt):/Lib --dir .::/',
    ...
    'LN': 'ln',
    'LOCALMODLIBS': '-lm -lm -lm -lm Modules/_decimal/libmpdec/libmpdec.a -L/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi -lz -L/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi -lbz2 -L/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi -lz Modules/_hacl/libHacl_Hash_MD5.a Modules/_hacl/libHacl_Hash_SHA1.a Modules/_hacl/libHacl_Hash_SHA2.a Modules/_hacl/libHacl_Hash_SHA3.a Modules/_hacl/libHacl_Hash_BLAKE2.a Modules/_hacl/libHacl_HMAC.a -lm Modules/expat/libexpat.a            -L/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi -lsqlite3               -lm',
    'MACHDEP': 'wasi',
    'MACHDEP_OBJS': '',
    ...
    'MODDISABLED_NAMES': '',
    'MODLIBS': '-lm -lm -lm -lm Modules/_decimal/libmpdec/libmpdec.a -L/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi -lz -L/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi -lbz2 -L/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi -lz Modules/_hacl/libHacl_Hash_MD5.a Modules/_hacl/libHacl_Hash_SHA1.a Modules/_hacl/libHacl_Hash_SHA2.a Modules/_hacl/libHacl_Hash_SHA3.a Modules/_hacl/libHacl_Hash_BLAKE2.a Modules/_hacl/libHacl_HMAC.a -lm Modules/expat/libexpat.a            -L/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi -lsqlite3               -lm',
    ...
    'MODULE_BINASCII_CFLAGS': '-DUSE_ZLIB_CRC32 -I/wlr/build-staging/python/v3.14.5/deps/build-output/include',
    'MODULE_BINASCII_LDFLAGS': '-L/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi -lz',
    ...
    'MODULE_ZLIB_CFLAGS': '-I/wlr/build-staging/python/v3.14.5/deps/build-output/include',
    'MODULE_ZLIB_LDFLAGS': '-L/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi -lz',
    ...
    'MODULE__BZ2_CFLAGS': '-I/wlr/build-staging/python/v3.14.5/deps/build-output/include',
    'MODULE__BZ2_LDFLAGS': '-L/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi -lbz2',
    ...
    'MODULE__SQLITE3_CFLAGS': '-I/wlr/build-staging/python/v3.14.5/deps/build-output/include -I./Modules/_sqlite',
    ...
    'MODULE__SQLITE3_LDFLAGS': '-L/wlr/build-staging/python/v3.14.5/deps/build-output/lib/wasm32-wasi -lsqlite3',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': "_PYTHON_HOSTRUNNER='wasmtime run --wasm max-wasm-stack=16777216 --wasi preview2=n --env PYTHONPATH=/$(shell realpath --relative-to /wlr/build-staging/python/v3.14.5/checkout /wlr/build-staging/python/v3.14.5/checkout)/$(shell cat pybuilddir.txt):/Lib --dir .::/' _PYTHON_PROJECT_BASE=/wlr/build-staging/python/v3.14.5/checkout _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /wlr/build-staging/python/v3.14.5/checkout/`cat pybuilddir.txt`) python3",
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': "_PYTHON_HOSTRUNNER='wasmtime run --wasm max-wasm-stack=16777216 --wasi preview2=n --env PYTHONPATH=/$(shell realpath --relative-to /wlr/build-staging/python/v3.14.5/checkout /wlr/build-staging/python/v3.14.5/checkout)/$(shell cat pybuilddir.txt):/Lib --dir .::/' _PYTHON_PROJECT_BASE=/wlr/build-staging/python/v3.14.5/checkout _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /wlr/build-staging/python/v3.14.5/checkout/`cat pybuilddir.txt`) python3",
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': "_PYTHON_HOSTRUNNER='wasmtime run --wasm max-wasm-stack=16777216 --wasi preview2=n --env PYTHONPATH=/$(shell realpath --relative-to /wlr/build-staging/python/v3.14.5/checkout /wlr/build-staging/python/v3.14.5/checkout)/$(shell cat pybuilddir.txt):/Lib --dir .::/' _PYTHON_PROJECT_BASE=/wlr/build-staging/python/v3.14.5/checkout _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /wlr/build-staging/python/v3.14.5/checkout/`cat pybuilddir.txt`) python3 -m test",
    ...
    'abs_builddir': '/wlr/build-staging/python/v3.14.5/checkout',
    'abs_srcdir': '/wlr/build-staging/python/v3.14.5/checkout',
