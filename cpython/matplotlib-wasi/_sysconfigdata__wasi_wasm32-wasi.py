...
build_time_vars = {
    ...
    'BLDSHARED': '/opt/wasi-sdk/bin/clang -shared -L/build/staging/deps/build-output/lib/wasm32-wasi -L/build/staging/deps/build-output/lib/wasm32-wasi',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.wasm',
    'BUILDPYTHON': 'python.wasm',
    'BUILD_GNU_TYPE': 'aarch64-unknown-linux-gnu',
    'BUILD_SCRIPTS_DIR': 'build/scripts-3.15',
    'BYTESTR_DEPS': '\\',
    'CC': '/opt/wasi-sdk/bin/clang',
    'CCSHARED': '',
    'CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -mtail-call',
    'CFLAGSFORSHARED': '',
    'CFLAGS_ALIASING': '',
    'CFLAGS_NODIST': '',
    ...
    'CONFIGURE_CFLAGS': '-Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include',
    ...
    'CONFIGURE_LDFLAGS': '-L/build/staging/deps/build-output/lib/wasm32-wasi',
    'CONFIGURE_LDFLAGS_NODIST': '-z stack-size=16777216 -Wl,--stack-first -Wl,--initial-memory=41943040',
    'CONFIGURE_LDFLAGS_NOLTO': '',
    'CONFIG_ARGS': "'-C' '--host=wasm32-wasip1' '--build=aarch64-unknown-linux-gnu' '--with-build-python=python3' '--without-doc-strings' '--without-system-libmpdec' '--with-tail-call-interp' 'build_alias=aarch64-unknown-linux-gnu' 'host_alias=wasm32-wasip1' 'PKG_CONFIG_PATH=/build/staging/deps/build-output/lib/wasm32-wasi/pkgconfig' 'PKG_CONFIG_LIBDIR=/build/staging/deps/build-output/lib/wasm32-wasi/pkgconfig' 'CC=/opt/wasi-sdk/bin/clang' 'CFLAGS=-Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include' 'LDFLAGS=-L/build/staging/deps/build-output/lib/wasm32-wasi'",
    'CONFINCLUDEDIR': '/usr/local/include',
    'CONFINCLUDEPY': '/usr/local/include/python3.15',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/build/staging/checkout/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/build/staging/checkout/lcov-report',
    'COVERAGE_REPORT_OPTIONS': '--rc lcov_branch_coverage=1 --branch-coverage --title "CPython 3.15 LCOV report [commit $(shell git --git-dir ./.git rev-parse --short HEAD)]"',
    'CPPFLAGS': '-I. -I./Include',
    'CXX': 'clang++',
    'DESTDIRS': '/usr/local /usr/local/lib /usr/local/lib/python3.15 /usr/local/lib/python3.15/lib-dynload',
    'DESTLIB': '/usr/local/lib/python3.15',
    'DESTPATH': '',
    'DESTSHARED': '/usr/local/lib/python3.15/lib-dynload',
    'DFLAGS': '',
    'DIRMODE': 755,
    ...
    'EXE': '.wasm',
    'EXEMODE': 755,
    'EXENAME': '/usr/local/bin/python3.15.wasm',
    'EXPORTSFROM': '',
    'EXPORTSYMS': '',
    'EXTRATESTOPTS': '',
    'EXT_SUFFIX': '.cpython-315-wasm32-wasi.so',
    'FILEMODE': 644,
    'FREEZE_MODULE': 'python3 ./Programs/_freeze_module.py',
    'FREEZE_MODULE_BOOTSTRAP': 'python3 ./Programs/_freeze_module.py',
    ...
    'HAVE_DB_H': 0,
    'HAVE_DECL_PR_SET_VMA_ANON_NAME': 0,
    ...
    'HAVE_EFFICIENT_BUILTIN_SHUFFLEVECTOR': 0,
    'HAVE_ENDIAN_H': 1,
    'HAVE_EPOLL': 0,
    ...
    'HAVE_STRUCT_STATX_STX_ATOMIC_WRITE_UNIT_MAX_OPT': 0,
    'HAVE_STRUCT_STATX_STX_ATOMIC_WRITE_UNIT_MIN': 0,
    'HAVE_STRUCT_STATX_STX_DIO_MEM_ALIGN': 0,
    'HAVE_STRUCT_STATX_STX_DIO_READ_OFFSET_ALIGN': 0,
    'HAVE_STRUCT_STATX_STX_MNT_ID': 0,
    'HAVE_STRUCT_STATX_STX_SUBVOL': 0,
    ...
    'INCLDIRSTOMAKE': '/usr/local/include /usr/local/include /usr/local/include/python3.15 /usr/local/include/python3.15',
    'INCLUDEDIR': '/usr/local/include',
    'INCLUDEPY': '/usr/local/include/python3.15',
    ...
    'INSTSONAME': 'libpython3.15.a',
    'IO_H': 'Modules/_io/_iomodule.h',
    'IO_OBJS': '\\',
    'IPHONEOS_DEPLOYMENT_TARGET': '',
    'JIT_DEPS': '\\',
    'LDCXXSHARED': 'clang++ -shared -L/build/staging/deps/build-output/lib/wasm32-wasi -L/build/staging/deps/build-output/lib/wasm32-wasi',
    'LDFLAGS': '-L/build/staging/deps/build-output/lib/wasm32-wasi -L/build/staging/deps/build-output/lib/wasm32-wasi',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.15.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': '/opt/wasi-sdk/bin/clang -shared -L/build/staging/deps/build-output/lib/wasm32-wasi -L/build/staging/deps/build-output/lib/wasm32-wasi',
    'LDVERSION': '3.15',
    'LIBC': '',
    'LIBDEST': '/usr/local/lib/python3.15',
    'LIBDIR': '/usr/local/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -mtail-call -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_32=1 -DANSI=1 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -mtail-call -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    'LIBOBJS': 'Python/dup2$U.o',
    'LIBPC': '/usr/local/lib/pkgconfig',
    'LIBPL': '/usr/local/lib/python3.15/config-3.15-wasm32-wasi',
    'LIBPYTHON': '',
    'LIBRARY': 'libpython3.15.a',
    'LIBRARY_DEPS': 'libpython3.15.a',
    'LIBRARY_OBJS': '\\',
    ...
    'LINKFORSHARED': '',
    'LINK_PYTHON_DEPS': 'libpython3.15.a',
    'LINK_PYTHON_OBJS': '\\',
    'LIPO_32BIT_FLAGS': '',
    'LIPO_INTEL64_FLAGS': '',
    'LLVM_PROF_ERR': 'yes',
    ...
    'LN': 'ln',
    'LOCALMODLIBS': '-lm -lm -lm -lm Modules/_decimal/libmpdec/libmpdec.a -L/lib/wasm32-wasi -lz -L/lib/wasm32-wasi -lbz2 -L/lib/wasm32-wasi -lz Modules/_hacl/libHacl_Hash_MD5.a Modules/_hacl/libHacl_Hash_SHA1.a Modules/_hacl/libHacl_Hash_SHA2.a Modules/_hacl/libHacl_Hash_SHA3.a Modules/_hacl/libHacl_Hash_BLAKE2.a Modules/_hacl/libHacl_HMAC.a -lm Modules/expat/libexpat.a            -L/lib/wasm32-wasi -lsqlite3 -luuid                -lm',
    'MACHDEP': 'wasi',
    'MACHDEP_OBJS': '',
    'MACHDESTLIB': '/usr/local/lib/python3.15',
    ...
    'MODULE_ZLIB_CFLAGS': '-I/include',
    'MODULE_ZLIB_LDFLAGS': '-L/lib/wasm32-wasi -lz',
    ...
    'MODULE__BZ2_CFLAGS': '-I/include',
    'MODULE__BZ2_LDFLAGS': '-L/lib/wasm32-wasi -lbz2',
    ...
    'MODULE__DECIMAL_DEPS': '\\ Modules/_decimal/libmpdec/libmpdec.a',
    ...
    'MODULE__MATH_INTEGER_LDFLAGS': '',
    'MODULE__MATH_INTEGER_STATE': 'yes',
    ...
    'MODULE__REMOTE_DEBUGGING_DEPS': './Modules/_remote_debugging/_remote_debugging.h',
    ...
    'MODULE__SQLITE3_CFLAGS': '-I/include  -I./Modules/_sqlite',
    ...
    'MODULE__SQLITE3_LDFLAGS': '-L/lib/wasm32-wasi -lsqlite3',
    ...
    'MODULE__TESTINTERNALCAPI_DEPS': './Modules/_testinternalcapi/parts.h ./Python/ceval.h ./Modules/_testinternalcapi/test_targets.h ./Modules/_testinternalcapi/test_cases.c.h',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': "_PYTHON_HOSTRUNNER='wasmtime run --wasm max-wasm-stack=16777216 --wasi preview2=n --dir .::/' _PYTHON_PROJECT_BASE=/build/staging/checkout _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /build/staging/checkout/`cat pybuilddir.txt`) python3",
    'PYTHON_FOR_BUILD_DEPS': '',
    'PYTHON_FOR_FREEZE': 'python3',
    'PYTHON_FOR_REGEN': '',
    'PYTHON_HEADERS': '\\',
    'PYTHON_OBJS': '\\',
    'PY_BUILTIN_HASHLIB_HASHES': '"md5,sha1,sha2,sha3,blake2"',
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -mtail-call -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -mtail-call',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -mtail-call -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -DPy_BUILD_CORE',
    'PY_CORE_LDFLAGS': '-L/build/staging/deps/build-output/lib/wasm32-wasi -L/build/staging/deps/build-output/lib/wasm32-wasi -z stack-size=16777216 -Wl,--stack-first -Wl,--initial-memory=41943040',
    'PY_CPPFLAGS': '-I. -I./Include',
    'PY_ENABLE_SHARED': 0,
    'PY_HAVE_PERF_TRAMPOLINE': 0,
    'PY_LDFLAGS': '-L/build/staging/deps/build-output/lib/wasm32-wasi -L/build/staging/deps/build-output/lib/wasm32-wasi',
    'PY_LDFLAGS_NODIST': '-z stack-size=16777216 -Wl,--stack-first -Wl,--initial-memory=41943040',
    'PY_LDFLAGS_NOLTO': '-L/build/staging/deps/build-output/lib/wasm32-wasi -L/build/staging/deps/build-output/lib/wasm32-wasi',
    'PY_SQLITE_ENABLE_LOAD_EXTENSION': 0,
    'PY_SQLITE_HAVE_SERIALIZE': 1,
    'PY_SSL_DEFAULT_CIPHERS': 1,
    'PY_SSL_DEFAULT_CIPHER_STRING': 0,
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -Os -Wno-int-conversion -Wno-unknown-attributes -I/build/staging/deps/build-output/include -mtail-call -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'PY_SUPPORT_TIER': 2,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 0,
    'Py_GIL_DISABLED': 0,
    ...
    'SCRIPT_IDLE': 'build/scripts-3.15/idle3.15',
    'SCRIPT_PYDOC': 'build/scripts-3.15/pydoc3.15',
    'SETPGRP_HAVE_ARG': 0,
    'SHELL': '/bin/sh -e',
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': "_PYTHON_HOSTRUNNER='wasmtime run --wasm max-wasm-stack=16777216 --wasi preview2=n --dir .::/' _PYTHON_PROJECT_BASE=/build/staging/checkout _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /build/staging/checkout/`cat pybuilddir.txt`) python3",
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': "_PYTHON_HOSTRUNNER='wasmtime run --wasm max-wasm-stack=16777216 --wasi preview2=n --dir .::/' _PYTHON_PROJECT_BASE=/build/staging/checkout _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /build/staging/checkout/`cat pybuilddir.txt`) python3 -m test",
    ...
    'ZIP_STDLIB': 'python3.15.zip',
    'abs_builddir': '/build/staging/checkout',
    'abs_srcdir': '/build/staging/checkout',
