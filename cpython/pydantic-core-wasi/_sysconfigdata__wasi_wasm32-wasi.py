...
build_time_vars = {
    ...
    'BLDSHARED': '/wasi-sdk/bin/clang -shared',
    'BOOTSTRAP_HEADERS': '\\',
    'BUILDEXE': '.wasm',
    'BUILDPYTHON': 'python.wasm',
    'BUILD_GNU_TYPE': 'x86_64-pc-linux-gnux32',
    'BUILD_SCRIPTS_DIR': 'build/scripts-3.14',
    'BYTESTR_DEPS': '\\',
    'CC': '/wasi-sdk/bin/clang',
    'CCSHARED': '',
    'CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O0 -Wno-int-conversion -O0 -Wno-int-conversion',
    'CFLAGSFORSHARED': '',
    'CFLAGS_ALIASING': '',
    'CFLAGS_NODIST': '',
    ...
    'CONFIGURE_CFLAGS': '-O0 -Wno-int-conversion',
    ...
    'CONFIG_ARGS': "'-C' '--host=wasm32-wasip1' '--build=x86_64-pc-linux-gnux32' '--with-build-python=python3' 'build_alias=x86_64-pc-linux-gnux32' 'host_alias=wasm32-wasip1' 'PKG_CONFIG_PATH=' 'PKG_CONFIG_LIBDIR=/wlr/build-staging/python/v3.14.0/deps/build-output/lib/wasm32-wasi/pkgconfig' 'CC=/wasi-sdk/bin/clang' 'CFLAGS=-O0 -Wno-int-conversion  ' 'LDFLAGS= '",
    'CONFINCLUDEDIR': '/usr/local/include',
    'CONFINCLUDEPY': '/usr/local/include/python3.14',
    'COREPYTHONPATH': '',
    'COVERAGE_INFO': '/wlr/build-staging/python/v3.14.0/checkout/coverage.info',
    'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
    'COVERAGE_REPORT': '/wlr/build-staging/python/v3.14.0/checkout/lcov-report',
    ...
    'HAVE__GETPTY': 0,
    'HAVE___UINT128_T': 1,
    'HOSTRUNNER': 'wasmtime run --wasm max-wasm-stack=16777216 --wasi preview2=n --env PYTHONPATH=/$(shell realpath --relative-to /wlr/build-staging/python/v3.14.0/checkout /wlr/build-staging/python/v3.14.0/checkout)/$(shell cat pybuilddir.txt):/Lib --dir .::/',
    ...
    'JIT_DEPS': '\\',
    'LDCXXSHARED': '/wasi-sdk/bin/clang++ -shared',
    'LDFLAGS': '',
    'LDFLAGS_NODIST': '',
    'LDLIBRARY': 'libpython3.14.a',
    'LDLIBRARYDIR': '',
    'LDSHARED': '/wasi-sdk/bin/clang -shared',
    'LDVERSION': '3.14',
    'LIBC': '',
    'LIBDEST': '/usr/local/lib/python3.14',
    'LIBDIR': '/usr/local/lib',
    'LIBEXPAT_A': 'Modules/expat/libexpat.a',
    'LIBEXPAT_CFLAGS': '-I./Modules/expat -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O0 -Wno-int-conversion -O0 -Wno-int-conversion -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'LIBEXPAT_HEADERS': '\\',
    'LIBEXPAT_OBJS': '\\',
    ...
    'LIBHACL_CFLAGS': '-I./Modules/_hacl -I./Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O0 -Wno-int-conversion -O0 -Wno-int-conversion -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'LIBHACL_HEADERS': '\\',
    ...
    'LIBMPDEC_CFLAGS': '-I./Modules/_decimal/libmpdec -DCONFIG_32=1 -DANSI=1 -fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O0 -Wno-int-conversion -O0 -Wno-int-conversion -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'LIBMPDEC_HEADERS': '\\',
    'LIBMPDEC_OBJS': '\\',
    'LIBOBJDIR': 'Python/',
    ...
    'LN': 'ln',
    'LOCALMODLIBS': '-lm -lm -lm -lm Modules/_decimal/libmpdec/libmpdec.a -L/wlr/build-staging/python/v3.14.0/deps/build-output/lib/wasm32-wasi -lz -L/wlr/build-staging/python/v3.14.0/deps/build-output/lib/wasm32-wasi -lbz2 -L/wlr/build-staging/python/v3.14.0/deps/build-output/lib/wasm32-wasi -lz Modules/_hacl/libHacl_Hash_MD5.a Modules/_hacl/libHacl_Hash_SHA1.a Modules/_hacl/libHacl_Hash_SHA2.a Modules/_hacl/libHacl_Hash_SHA3.a Modules/_hacl/libHacl_Hash_BLAKE2.a Modules/_hacl/libHacl_HMAC.a -lm Modules/expat/libexpat.a            -L/wlr/build-staging/python/v3.14.0/deps/build-output/lib/wasm32-wasi -lsqlite3               -lm',
    'MACHDEP': 'wasi',
    'MACHDEP_OBJS': '',
    ...
    'MODULE_ZLIB_CFLAGS': '-I/wlr/build-staging/python/v3.14.0/deps/build-output/include',
    'MODULE_ZLIB_LDFLAGS': '-L/wlr/build-staging/python/v3.14.0/deps/build-output/lib/wasm32-wasi -lz',
    ...
    'MODULE__BZ2_CFLAGS': '-I/wlr/build-staging/python/v3.14.0/deps/build-output/include',
    'MODULE__BZ2_LDFLAGS': '-L/wlr/build-staging/python/v3.14.0/deps/build-output/lib/wasm32-wasi -lbz2',
    ...
    'MODULE__SQLITE3_CFLAGS': '-I/wlr/build-staging/python/v3.14.0/deps/build-output/include -I./Modules/_sqlite',
    ...
    'MODULE__SQLITE3_LDFLAGS': '-L/wlr/build-staging/python/v3.14.0/deps/build-output/lib/wasm32-wasi -lsqlite3',
    ...
    'PYTHONPATH': '',
    'PYTHON_FOR_BUILD': "_PYTHON_HOSTRUNNER='wasmtime run --wasm max-wasm-stack=16777216 --wasi preview2=n --env PYTHONPATH=/$(shell realpath --relative-to /wlr/build-staging/python/v3.14.0/checkout /wlr/build-staging/python/v3.14.0/checkout)/$(shell cat pybuilddir.txt):/Lib --dir .::/' _PYTHON_PROJECT_BASE=/wlr/build-staging/python/v3.14.0/checkout _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /wlr/build-staging/python/v3.14.0/checkout/`cat pybuilddir.txt`) python3",
    ...
    'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O0 -Wno-int-conversion -O0 -Wno-int-conversion -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -DPy_BUILD_CORE_BUILTIN',
    'PY_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O0 -Wno-int-conversion -O0 -Wno-int-conversion',
    ...
    'PY_CORE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O0 -Wno-int-conversion -O0 -Wno-int-conversion -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include -DPy_BUILD_CORE',
    ...
    'PY_STDMODULE_CFLAGS': '-fno-strict-overflow -Wsign-compare -Wunreachable-code -DNDEBUG -g -O3 -Wall -O0 -Wno-int-conversion -O0 -Wno-int-conversion -std=c11 -Wextra -Wno-unused-parameter -Wno-int-conversion -Wno-missing-field-initializers -Wstrict-prototypes -Werror=implicit-function-declaration -fvisibility=hidden  -I./Include/internal -I./Include/internal/mimalloc -I. -I./Include',
    'PY_SUPPORT_TIER': 2,
    'Py_DEBUG': 0,
    'Py_ENABLE_SHARED': 0,
    'Py_GIL_DISABLED': 0,
    ...
    'TESTOPTS': '',
    'TESTPATH': '',
    'TESTPYTHON': "_PYTHON_HOSTRUNNER='wasmtime run --wasm max-wasm-stack=16777216 --wasi preview2=n --env PYTHONPATH=/$(shell realpath --relative-to /wlr/build-staging/python/v3.14.0/checkout /wlr/build-staging/python/v3.14.0/checkout)/$(shell cat pybuilddir.txt):/Lib --dir .::/' _PYTHON_PROJECT_BASE=/wlr/build-staging/python/v3.14.0/checkout _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /wlr/build-staging/python/v3.14.0/checkout/`cat pybuilddir.txt`) python3",
    'TESTPYTHONOPTS': '',
    'TESTRUNNER': "_PYTHON_HOSTRUNNER='wasmtime run --wasm max-wasm-stack=16777216 --wasi preview2=n --env PYTHONPATH=/$(shell realpath --relative-to /wlr/build-staging/python/v3.14.0/checkout /wlr/build-staging/python/v3.14.0/checkout)/$(shell cat pybuilddir.txt):/Lib --dir .::/' _PYTHON_PROJECT_BASE=/wlr/build-staging/python/v3.14.0/checkout _PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) PYTHONPATH=./Lib _PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasi_wasm32-wasi _PYTHON_SYSCONFIGDATA_PATH=$(shell test -f pybuilddir.txt && echo /wlr/build-staging/python/v3.14.0/checkout/`cat pybuilddir.txt`) python3 -m test",
    ...
    'abs_builddir': '/wlr/build-staging/python/v3.14.0/checkout',
    'abs_srcdir': '/wlr/build-staging/python/v3.14.0/checkout',
